...
var validOcapiVersionRegex = new RegExp(/^\d{2}_\d$/);
...
module.exports = {
    ...
    REFRESH_TOKEN_COOKIE_AGE_REGISTERED: 90 * 24 * 60 * 60,

    // This is set to match the currently 30 day expiration of guest refresh tokens
    REFRESH_TOKEN_COOKIE_AGE_GUEST: 30 * 24 * 60 * 60,
